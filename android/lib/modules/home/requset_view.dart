...
class RequsetView extends StatefulWidget {
  ...
  final Function createRide;
  final Function reset;
  final Function selectCash;
  final Function selectCard;
  final tripDetails;

  const RequsetView(
      {Key key, this.onBack, this.tripDetails, this.createRide, this.reset, this.selectCash, this.selectCard})
      : super(key: key);
...
class _RequsetViewState extends State<RequsetView>
  ...
  void getCredit() async {
    ...
    DatabaseReference reference = FirebaseDatabase.instance.reference().child('userCredit/$phoneNumber');
